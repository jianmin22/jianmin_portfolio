...
export default function AboutMe() {
  return (
    <main className="flex min-h-screen flex-col items-center bg-gray-900">
      ...
      <div className="container flex flex-row justify-between items-center gap-12 px-4">
        <img src="../../images/aboutme-img1.jpg" alt="About Me" className="rounded-lg w-96" />
        <div className="bg-white flex items-center justify-center h-full shadow-lg rounded-lg">
      ...
      <div className="border border-white p-4 rounded-lg mb-10">
        <div className="container flex flex-row justify-between items-center gap-12 px-4">
          <img src="../../images/isfj.png" alt="About Me" className="rounded-lg w-96" />
